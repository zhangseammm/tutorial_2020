...
(cl:defmethod cl:initialize-instance :after ((m <direction_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'direction_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name little_car-msg:<direction_msg> is deprecated: use little_car-msg:direction_msg instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <direction_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader little_car-msg:state-val is deprecated.  Use little_car-msg:state instead.")
  (state m))

(cl:ensure-generic-function 'rusult-val :lambda-list '(m))
(cl:defmethod rusult-val ((m <direction_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader little_car-msg:rusult-val is deprecated.  Use little_car-msg:rusult instead.")
  (rusult m))
